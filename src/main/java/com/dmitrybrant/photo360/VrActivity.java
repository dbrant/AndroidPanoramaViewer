...
public class VrActivity extends GvrActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gvrView.setOnCloseButtonListener(this::launch2dActivity);
    ...
    private void launch2dActivity() {
        startActivity(new Intent(getIntent()).setClass(this, MainActivity.class));
    ...
    private class Renderer implements GvrView.StereoRenderer {
        ...
        public Renderer(ViewGroup parent) {
            Pair<SceneRenderer, VideoUiView> pair
                    = SceneRenderer.createForVR(VrActivity.this, parent);
            scene = pair.first;
            uiView = pair.second;
            uiView.setVrIconClickListener(v -> {
                if (!exitFromVr()) {
